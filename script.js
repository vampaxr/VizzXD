...
function renderBuiltInProjects() {
    ...
    const projects = [

        {
            ...
            description:
                "A custom event made for players to compete and have fun.",
            short: "EVENT"
        },

        {
            title: "Server Plugin",
            description:
                "A custom plugin made to add new features to a server.",
            short: "PLUG"
        },

        {
            title: "SMP Project",
            description:
                "Custom features and ideas made for a Minecraft SMP.",
            short: "SMP"
        },

        {
            title: "More Projects",
            description:
                "More plugins and projects will be added here.",
            short: "DEV"
        }
...
async function loadDiary() {
    ...
    try {
        ...
        if (!Array.isArray(entries)) {
            throw new Error(
                "diary.json must contain an array"
            );
        }
...
function renderBuiltInDiary() {
    ...
    const entries = [

        {
            ...
            title: "New portfolio",
            description:
                "Made a new website for my projects."
        },

        {
            ...
            description:
                "Working on a new Minecraft event."
        },

        {
            ...
            title: "Plugin work",
            description:
                "Working on some new server features."
        }
